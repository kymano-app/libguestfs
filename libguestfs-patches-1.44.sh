...
autoreconf -i
make CFLAGS="-I/opt/local/include -I/usr/local/include -I/System/Volumes/Data/opt/homebrew/Cellar/pcre2/10.39/include/ -I/System/Volumes/Data/opt/homebrew/Cellar/gettext/0.21/include -Wno-error=implicit-function-declaration -I/usr/local/Cellar/readline/8.1.2/include/readline/"
./configure --disable-appliance --enable-vala=no --disable-rust --enable-introspection=no --disable-gobject --disable-golang --disable-lua --disable-php --disable-erlang --disable-haskell --disable-ruby --disable-python  --disable-perl --disable-ocaml --disable-libtool-lock --disable-dependency-tracking --disable-option-checking --disable-rust --with-distro=openbsd --disable-probes  --disable-daemon --disable-fuse --exec-prefix=/opt/local/ LDFLAGS="-twolevel_namespace" LIBS="-lintl" CFLAGS="-I/usr/local/Cellar/readline/8.1.2/include/readline/" CPPFLAGS="-I/usr/local/Cellar/readline/8.1.2/include/readline/"

make CFLAGS="-I/opt/local/include -I/usr/local/include -I/System/Volumes/Data/opt/homebrew/Cellar/pcre2/10.39/include/ -I/System/Volumes/Data/opt/homebrew/Cellar/gettext/0.21/include -Wno-error=implicit-function-declaration -I/usr/local/Cellar/readline/8.1.2/include/readline/" CPPFLAGS="-I/usr/local/Cellar/readline/8.1.2/include/readline/"